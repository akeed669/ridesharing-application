...
import { BookingCanceledListener } from "./events/listeners/booking-canceled-listener";
...
const start = async () => {
  ...
  try {
    ...
    new BookingCanceledListener(natsWrapper.client).listen();
  ...
  app.listen(3000, () => {
    console.log("Listening on port 3000..rides!.");
  });
};
